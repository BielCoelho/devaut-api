...
import { AuthUserInput, CreateUserInput, UpdateUserInput } from 'inputs/user.inputs';
...
export class UserResolver {
  ...
  @Mutation(() => UserWithToken)
  @UseGuards(AuthorizationGuard)
  async updateUser(@Args('data') data: UpdateUserInput, @CurrentUser() { user }: UserWithToken) {
